...
namespace McAttributes.Controllers {
    ...
    public class CohortDescrptionController : ControllerBase {
        ...
        public CohortDescrptionController(ILogger<CohortDescrptionController> logger, IdDbContext dbContext) {
            _logger = logger;
            _ctx = dbContext;
        ...
        // GET api/<CohortDescrptionController>/5
        [HttpGet("{id}")]
        public IActionResult Get([FromRoute] string id) {
            ...
            if (id is string memberId) {
                ...
                var result = retry.ExecuteAndCapture(() => _ctx.Set<CohortDescription>().Where(x => x.CohortMembers.Any(m => m.Id == memberId)).ToList());
        ...
        // POST api/<CohortDescrptionController>
        [HttpPost]
        ...
        // PUT api/<CohortDescrptionController>/5
        [HttpPut("{id}")]
        ...
        // PATCH api/<CohortDescrptionController>/5
        [HttpPatch("{id}")]
        ...
        // DELETE api/<CohortDescrptionController>/5
        [HttpDelete("{id}")]
